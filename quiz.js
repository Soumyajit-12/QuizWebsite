...
const entryForm = document.querySelector('.name');
...
function showResultBox(){
    ...
    if(userScore > 2){
        let scoreTag = '<span>Good Job! ' + userName.value + ' got <p>'+ userScore +'</p>out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span>Sorry! ' + userName.value + ' got <p>'+ userScore +'</p>out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}